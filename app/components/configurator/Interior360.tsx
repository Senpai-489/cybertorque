...
function Panorama({ image }: { image: string }) {
  ...
  useEffect(() => {
    ...
    const onPointerMove = (event: PointerEvent) => {
      ...
      targetYaw.current = startYaw.current - dx * 0.004;
      targetPitch.current = startPitch.current - dy * 0.004;
  ...
  /* ==========================================================
     CAMERA ROTATION VIA R3F FRAME LOOP
  ========================================================== */
  useFrame(({ camera }) => {
  ...
  if (error) {
    console.error("[360 PANORAMA] Image could not be loaded:", image);
  }
